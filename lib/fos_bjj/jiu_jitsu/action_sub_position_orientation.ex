defmodule FosBjj.JiuJitsu.ActionSubPositionOrientation do
  ...
  @config_triples [
    ...
    {"ashi_waza", "offense", "transitions"},
    {"ashi_waza", "defense", "transitions"},
    {"sacrifice_sutemi_waza", "offense", "takedowns"},
    ...
    {"low_mount", "bottom", "reversals"},
    {"low_mount", "top", "submissions"},
    {"low_mount", "top", "transitions"},
    {"low_mount", "top", "maintaining"},
    {"technical_mount", "bottom", "escapes"},
    {"technical_mount", "bottom", "reversals"},
    {"technical_mount", "top", "submissions"},
    {"technical_mount", "top", "transitions"},
    {"technical_mount", "top", "maintaining"},
