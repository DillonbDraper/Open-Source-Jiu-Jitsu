defmodule FosBjjWeb.Components.Clipboard do
  @moduledoc """
  The `FosBjjWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
