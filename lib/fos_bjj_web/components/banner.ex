defmodule FosBjjWeb.Components.Banner do
  @moduledoc """
  FosBjjWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
