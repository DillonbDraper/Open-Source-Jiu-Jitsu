defmodule FosBjjWeb.Components.CheckboxCard do
  @moduledoc """
  The `FosBjjWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
