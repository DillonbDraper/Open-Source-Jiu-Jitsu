defmodule FosBjjWeb.Components.Spinner do
  @moduledoc """
  The `FosBjjWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `FosBjjWeb.Components.Spinner` module enables developers to provide
