defmodule FosBjjWeb.Components.TextareaField do
  @moduledoc """
  The `FosBjjWeb.Components.TextareaField` module provides a versatile and customizable textarea field component
