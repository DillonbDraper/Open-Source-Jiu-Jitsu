defmodule FosBjjWeb.Components.Menu do
  @moduledoc """
  The `FosBjjWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `FosBjjWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import FosBjjWeb.Components.Button, only: [button_link: 1]
