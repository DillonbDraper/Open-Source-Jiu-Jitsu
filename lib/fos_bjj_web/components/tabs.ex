defmodule FosBjjWeb.Components.Tabs do
  @moduledoc """
  `FosBjjWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import FosBjjWeb.Components.Badge, only: [badge: 1]
