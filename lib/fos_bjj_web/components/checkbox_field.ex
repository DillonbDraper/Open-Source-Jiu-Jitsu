defmodule FosBjjWeb.Components.CheckboxField do
  @moduledoc """
  FosBjjWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
