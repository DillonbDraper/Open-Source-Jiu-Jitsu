defmodule FosBjjWeb.Components.ScrollArea do
  @moduledoc """
  The `FosBjjWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
