...
config :fos_bjj,
  ecto_repos: [FosBjj.Repo],
  generators: [timestamp_type: :utc_datetime],
  ash_domains: [FosBjj.Accounts, FosBjj.JiuJitsu]
...
config :fos_bjj, FosBjjWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: FosBjjWeb.ErrorHTML, json: FosBjjWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: FosBjj.PubSub,
  live_view: [signing_salt: "7gHI02uh"]
